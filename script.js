// CryptoJS imported from https://github.com/brix/crypto-js
...
document.querySelector("#submit-button").addEventListener("click", function(){
  ...
  if(passField.value != "") {
    ...
    document.querySelector("#text-area").value = pass;
  }
});

document.querySelector("#text-area").addEventListener("click", function() {
